...
var options = {
     ...
     channel : "Teste",
     uid: null,
     token : "006c90015364b5643f4b42b4ce5dae71dcdIABkWkoHLUfAupu4OTr8BzbDzo8BfADgSY56XQCrFYYiiQtmdScAAAAAEACgcVr/Jdt6YgEAAQAk23pi",
     //key : process.env.KEY,
...
function Agora() {
  ...
  const joinChannel =  async (role) =>{
      // Create a client
         ...
         await rtc.client.init(options.appId,()=>{
